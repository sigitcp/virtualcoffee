    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2>Explore Your Coffee Spot</h2>
                  ...
                  <div class="hover-effect">
                    <div class="content">
                      ...
                      <span class="author">
                        ...
                        <h6>Coffee Dummy 1<br><a href="#" target="blank">@libertyart</a></h6>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="thumb">
                  ...
                  <div class="hover-effect">
                    <div class="content">
                      ...
                      <span class="author">
                        <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        <h6>Coffee Dummy 2<br><a href="#">@libertyart</a></h6>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="thumb">
                  ...
                  <div class="hover-effect">
                    <div class="content">
                      ...
                      <span class="author">
                        <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        <h6>Coffee Dummy 3<br><a href="#">@libertyart</a></h6>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="thumb">
                  ...
                  <div class="hover-effect">
                    <div class="content">
                      ...
                      <span class="author">
                        <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        <h6>Coffee Dummy 4<br><a href="#">@libertyart</a></h6>
                      </span>
                    </div>
                  </div>
                </div>
